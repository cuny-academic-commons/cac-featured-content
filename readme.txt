...
The CAC Featured Content plugin provides a widget that allows you to select among five different content "types" to feature in a widget area somewhere within your theme. The five content types are: Blog, Post, Member (Content pulled from buddy press user profile), Group (Buddy Press group), and Resource which is a free-form type.  
